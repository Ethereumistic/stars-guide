    ...
    const inner = (
        <>
            <CardHeader className={headerCn}>
                <CardTitle className="font-serif text-3xl tracking-tight text-foreground">Welcome Back</CardTitle>
                <CardDescription className="font-sans italic text-muted-foreground">Continue your cosmic journey</CardDescription>
            </CardHeader>
            <CardContent className={contentCn}>
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase"><span className="bg-background px-2 text-muted-foreground font-sans">Or continue with</span></div>
                </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="grid gap-2">
                            <div className="flex items-center justify-between ml-1">
                                ...
                                <Link href="/forgot-password" className="text-xs text-primary hover:underline font-medium italic">Forgot password?</Link>
                            </div>
                            <div className="relative">
            ...
            <CardFooter className={footerCn}>
                ...
                <Link href="/sign-up" className="text-primary hover:underline font-medium italic">Create an account</Link>
            </CardFooter>
        </>
    )

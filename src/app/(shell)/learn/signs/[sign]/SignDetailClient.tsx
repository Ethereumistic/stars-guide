...
import { TbSparkles, TbCompass, TbTriangleSquareCircle } from "react-icons/tb";
import {
  GiChessKnight,
  GiMightyForce,
  GiBrokenShield,
...
export function SignDetailClient({
  signId,
}: {
  signId: string;
}) {
            ...
            <SignSpecsGrid
              specs={[
                ...
                },
                {
                  label: "Ruler",
                  value:
                    data.ruler.charAt(0).toUpperCase() + data.ruler.slice(1),
                  icon: TbSparkles,
            ...
            <div className="grid grid-cols-2 border-b border-white/10">
              {[
                ...
                },
                {
                  ...
                  val: data.coreStrategy,
                  icon: GiChessKnight,
                },
              ].map((spec, i) => (
                <div
                  key={i}
                  className={`p-6 space-y-3 border-white/10 ${
                    i % 2 === 0 ? "border-r" : ""
                  } ${i < 2 ? "border-b" : ""}`}
                >
              ...
              <div className="relative z-10 space-y-8">
                ...
                >
                  <p className="text-xl text-white/90 italic font-serif leading-relaxed">
                    &ldquo;{manifestation.insight}&rdquo;
                  </p>
                </blockquote>

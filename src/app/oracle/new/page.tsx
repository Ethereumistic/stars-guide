      ...
      {isOracleOffline ? (
        ...
        >
          <motion.div
            ...
            className="mb-8"
          >
            <div className="size-42 rounded-full flex items-center justify-center relative">
              ...
              <GiCursedStar className="size-33 text-galactic" />
            </div>
          </motion.div>
          ...
          >
            ...
            {quota && quota.remaining !== undefined && (
              <div className="flex justify-end mt-2 px-2">
                ...
                >
                  {quota.remaining} question{quota.remaining !== 1 ? "s" : ""}{" "}
                  remaining
                  {quota.resetsAt
